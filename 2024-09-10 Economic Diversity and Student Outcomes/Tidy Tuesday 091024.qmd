...
logos <- data.frame(
  ...
  logo_url2 = c("/Users/cristianthirteen/Downloads/Notre Dame/Tidy Tuesday/2024-09-10 Economic Diversity and Student Outcomes/Harvard_University.png", 
               "/Users/cristianthirteen/Downloads/Notre Dame/Tidy Tuesday/2024-09-10 Economic Diversity and Student Outcomes/Yale_University.png", 
               "/Users/cristianthirteen/Downloads/Notre Dame/Tidy Tuesday/2024-09-10 Economic Diversity and Student Outcomes/University_of_Michigan.png", 
               "/Users/cristianthirteen/Downloads/Notre Dame/Tidy Tuesday/2024-09-10 Economic Diversity and Student Outcomes/University_of_California,_Berkeley.png", 
               "/Users/cristianthirteen/Downloads/Notre Dame/Tidy Tuesday/2024-09-10 Economic Diversity and Student Outcomes/Princeton_logo.png", 
               "/Users/cristianthirteen/Downloads/Notre Dame/Tidy Tuesday/2024-09-10 Economic Diversity and Student Outcomes/University_of_Pennsylvania.png", 
               "/Users/cristianthirteen/Downloads/Notre Dame/Tidy Tuesday/2024-09-10 Economic Diversity and Student Outcomes/Stanford_logo.png", 
               "/Users/cristianthirteen/Downloads/Notre Dame/Tidy Tuesday/2024-09-10 Economic Diversity and Student Outcomes/MIT.png", 
               "/Users/cristianthirteen/Downloads/Notre Dame/Tidy Tuesday/2024-09-10 Economic Diversity and Student Outcomes/Cornell_University.png", 
               "/Users/cristianthirteen/Downloads/Notre Dame/Tidy Tuesday/2024-09-10 Economic Diversity and Student Outcomes/University_of_Chicago.png", 
               "/Users/cristianthirteen/Downloads/Notre Dame/Tidy Tuesday/2024-09-10 Economic Diversity and Student Outcomes/Northwestern_University.png", 
               "/Users/cristianthirteen/Downloads/Notre Dame/Tidy Tuesday/2024-09-10 Economic Diversity and Student Outcomes/Columbia_University.png", 
               "/Users/cristianthirteen/Downloads/Notre Dame/Tidy Tuesday/2024-09-10 Economic Diversity and Student Outcomes/University_of_Texas.png", 
               "/Users/cristianthirteen/Downloads/Notre Dame/Tidy Tuesday/2024-09-10 Economic Diversity and Student Outcomes/Washington_University_in_St._Louis.png", 
               "/Users/cristianthirteen/Downloads/Notre Dame/Tidy Tuesday/2024-09-10 Economic Diversity and Student Outcomes/University_of_Notre_Dame.png")
)
...
ggplot(attendance_combined_top, aes(x = lower_income_attendance_percent, 
  ...
  geom_text(aes(x = upper_income_attendance_percent, label = paste0(round(upper_income_attendance_percent, 1), "%")), hjust = -0.2, size = 3.5) + # Upper-income label
  geom_text(aes(label = paste0(round(gap * 100, 1), "%"), x = (lower_income_attendance_percent + upper_income_attendance_percent) / 2), color = "black", vjust = -1.5, size = 3.5) + # Adding the gap label, rounded to 2 decimals
  geom_image(aes(image = logo_url, y = reorder(name, gap)), x = -0.05, size = 0.05, by = "height") + # Adding logos
  labs(title = "Comparison of Attendance Rates by Income Group",
       subtitle = "Lower-Income vs. Upper-Income Students at Selective Universities",
       x = "Attendance Rate (%)", 
       y = "University") +
  theme_minimal() +
  theme(axis.text.x = element_blank(), 
...
# Group by school and calculate the number of students from lower-income bins attending each school
schools_for_poor_kids <- low_income_data %>%
  group_by(name) %>% # Group data by school name
  summarise(lower_income_attendance = sum(attend_unwgt, na.rm = TRUE)) %>% # Summarize attendance by summing up the number of students
  arrange(desc(lower_income_attendance)) # Arrange schools in descending order of attendance rate

# Filter data for upper income bins income >= 92.5
rich_income_data <- ca %>% 
  filter(par_income_bin >= 92.5)

# Group by school and calculate the number of students from upper-income bins attending each school
schools_for_super_rich_kids <- rich_income_data %>%
  group_by(name) %>% # Group data by school name
  summarise(upper_income_attendance = sum(attend_unwgt, na.rm = TRUE)) %>% # Summarize attendance by summing up the number of students
  arrange(desc(upper_income_attendance)) # Arrange schools in descending order of attendance rate

# Combine the two datasets: schools_for_poor_kids and schools_for_super_rich_kids
attendance_combined <- schools_for_poor_kids %>%
  left_join(schools_for_super_rich_kids, by = "name") %>% # Merge data frames by school name
  mutate(gap = upper_income_attendance - lower_income_attendance) # Calculate the gap between upper and lower-income attendance
...
logos <- data.frame(
  name = c("Harvard University", "Yale University", "University Of Michigan - Ann Arbor", 
           ...
           "Columbia University In The City Of New York", "University Of Texas At Austin", 
           "Washington University In St. Louis", "University Of Notre Dame"),
  logo_url = c("/Users/cristianthirteen/Downloads/Notre Dame/Tidy Tuesday/2024-09-10 Economic Diversity and Student Outcomes/Harvard_Crimson.png", 
               "/Users/cristianthirteen/Downloads/Notre Dame/Tidy Tuesday/2024-09-10 Economic Diversity and Student Outcomes/Yale_Bulldogs.png", 
               "/Users/cristianthirteen/Downloads/Notre Dame/Tidy Tuesday/2024-09-10 Economic Diversity and Student Outcomes/Michigan.png", 
               "/Users/cristianthirteen/Downloads/Notre Dame/Tidy Tuesday/2024-09-10 Economic Diversity and Student Outcomes/University_Of_California_Berkeley.png", 
               "/Users/cristianthirteen/Downloads/Notre Dame/Tidy Tuesday/2024-09-10 Economic Diversity and Student Outcomes/Princeton.png", 
               "/Users/cristianthirteen/Downloads/Notre Dame/Tidy Tuesday/2024-09-10 Economic Diversity and Student Outcomes/Penn.png", 
               "/Users/cristianthirteen/Downloads/Notre Dame/Tidy Tuesday/2024-09-10 Economic Diversity and Student Outcomes/Stanford.png", 
               "/Users/cristianthirteen/Downloads/Notre Dame/Tidy Tuesday/2024-09-10 Economic Diversity and Student Outcomes/MIT.png", 
               "/Users/cristianthirteen/Downloads/Notre Dame/Tidy Tuesday/2024-09-10 Economic Diversity and Student Outcomes/Cornell.png", 
               "/Users/cristianthirteen/Downloads/Notre Dame/Tidy Tuesday/2024-09-10 Economic Diversity and Student Outcomes/Chicago.png", 
               "/Users/cristianthirteen/Downloads/Notre Dame/Tidy Tuesday/2024-09-10 Economic Diversity and Student Outcomes/Northwestern.png", 
               "/Users/cristianthirteen/Downloads/Notre Dame/Tidy Tuesday/2024-09-10 Economic Diversity and Student Outcomes/Columbia.png", 
               "/Users/cristianthirteen/Downloads/Notre Dame/Tidy Tuesday/2024-09-10 Economic Diversity and Student Outcomes/Texas_Longhorns.png", 
               "/Users/cristianthirteen/Downloads/Notre Dame/Tidy Tuesday/2024-09-10 Economic Diversity and Student Outcomes/WashU.png", 
               "/Users/cristianthirteen/Downloads/Notre Dame/Tidy Tuesday/2024-09-10 Economic Diversity and Student Outcomes/Notre_Dame.png")
)
...
ggplot(attendance_combined_top, aes(x = lower_income_attendance_percent, 
  ...
  geom_text(aes(x = lower_income_attendance_percent, 
                label = paste0(round(lower_income_attendance_percent, 1), "%")), hjust = 1.5, size = 3.5) + # Lower-income label
  geom_text(aes(x = upper_income_attendance_percent, label = paste0(round(upper_income_attendance_percent, 1), "%")), hjust = -0.2, size = 3.5) + # Upper-income label
  geom_text(aes(label = paste0(round(gap * 100, 1), "%"), x = (lower_income_attendance_percent + upper_income_attendance_percent) / 2), color = "black", vjust = -1.5, size = 3.5) + # Adding the gap label, rounded to 1 decimal
  geom_image(aes(x = -1.8, y = reorder(name, gap), image = logo_url), size = 0.05, by = "height") + # Adding logos
  labs(title = "Comparison of Attendance Rates by Income Group",
       subtitle = "Lower-Income vs. Upper-Income Students",
       x = "Attendance Rate (%)", 
       y = NULL) + # Remove the y-axis title
...
```{r include=FALSE}
highly_selective_private <- merged_ca %>% 
  filter(tier == "Highly selective private")
unique(highly_selective_private$name)

elite_schools <- merged_ca %>% 
  filter(tier == "Other elite schools (public and private)")
unique(elite_schools$name)

selective_public <- merged_ca %>% 
  filter(tier == "Selective public")
unique(selective_public$name)

Highly_selective_public <- merged_ca %>% 
  filter(tier == "Highly selective public")
unique(Highly_selective_public$name)

selective_private <- merged_ca %>% 
  filter(tier == "Selective private")
unique(selective_private$name)



unique(merged_ca$tier)

unique(merged_ca$test_band_tier)
```
